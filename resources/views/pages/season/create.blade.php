...
{{-- page title --}}
@section('title','Create a new Season')
{{-- vendor style --}}
        ...
        <div class="card-content">
            <div class="card-title">
                <div class="row center">
                    <div class="col s12">
                        <h5 class="center-align" style="font-weight: 900;">Create a New Season</h5>
                    </div>
            ...
            @endif
            <form  class="formValidate" action="{{ route('admin-season.store') }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
