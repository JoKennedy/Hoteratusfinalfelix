...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('admin-season.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Create Season</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Season</span>
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        filter(1);
                        swal("Season  has been deactivated!", {
                            icon: "success",
                        });
