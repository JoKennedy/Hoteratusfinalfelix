...
{{-- page title --}}
@section('title','Create a new Dynamic Pricing')
{{-- vendor style --}}
        ...
        <div class="card-content">
            <div class="card-title">
                <div class="row center">
                    <div class="col s12">
                        <h5 class="center-align" style="font-weight: 900;">Create a New Dynamic Pricing</h5>
                    </div>
                </div>
            </div>

            <form  class="formValidate" action="{{ route('dynamic-pricing.store') }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
                ...
                <div id="details">
                    ...
                    <table id="discountlist">
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center; padding: 5px;"><input style="text-align: center;"  onkeypress="return isNumberKey(event)"  name="start_occupancy[]" type="text"  required> </td>
                                <td style="text-align:center; padding: 5px;"><input  style="text-align: center;" onkeypress="return isNumberKey(event)"  name="end_occupancy[]" type="text"  required> </td>
