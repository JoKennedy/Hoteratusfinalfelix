...
{{-- page title --}}
@section('title','Dinamic Pricing List')
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('dynamic-pricing.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='javascript:void(0)'
      ...
      <span class="hide-on-small-only">Filter Dinamic Pricing</span>
...
<script >
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        swal("Dinamic Pricing  has been deactivated!", {
                            icon: "success",
                        });
                ...
                swal("Your Dinamic Pricing is safe", {
                    title: 'Cancelled',
                    icon: "error",
                });
                }
    ...
    function fetch_data( active = '') {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Dinamic Pricing"
        },
        select: {
            style: "multi",
