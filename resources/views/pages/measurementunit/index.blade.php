...
{{-- page title --}}
@section('title',"Measurement Unit List")
...
<section class="invoice-list-wrapper section">
 ...
 <div class="invoice-filter-action mr-3">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('measurement-units.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Add new Measurement Unit</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Measurement Unit </span>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th></th>
          <th>
            <span>Measurement Unit Name</span>
          </th>
          <th>Symbol</th>
          <th>Action</th>
          <th>Status</th>
...
<script >
    ...
    function deactive(id,obj){
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "{!!URL::to('measurement-units/"+id+"' )!!}" ,
                        method: 'DELETE',
                        ...
                        swal("Measurement Unit  has been deactivated!", {
                            icon: "success",
                        });
                ...
                swal("Your Measurement Unit is safe", {
                    title: 'Cancelled',
                    icon: "error",
                });
                }
    ...
    function fetch_data( active = '') {
        ...
        var dataListView = $(".invoice-data-table").DataTable({
            ...
            aaSorting: [],
        "ajax": {
             "url":  "{{ route('measurement-units.index')}}",
            "data": function( d ) {
                d.active=  $('#filter').val();
                }
        }  ,
