...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('room-types.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Create Room Type</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Room Type</span>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr  >
          ...
          <th  class="text-center" >Occupancy <hr> Base / Maximum </th>
          <th class="text-center" >Rooms</th>
        <th class="text-center" >Extra Bed(s) <br> Allowed</th>
          <th>Action</th>
          <th>Status</th>
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        swal("Room Type  has been deactivated!", {
                            icon: "success",
                        });
