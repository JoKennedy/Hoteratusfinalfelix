...
<section class="invoice-list-wrapper section">
 ...
 <div class="invoice-filter-action mr-3">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('packages-master.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Add new Package</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Package </span>
...
<script >
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        if(response.active == 1){
                         ...
                         $(".loader").hide();
                        swal("Package  has been deactivated!", {
                            icon: "success",
                        });
    ...
    function fetch_data( active = '') {
        ...
        var dataListView = $(".invoice-data-table").DataTable({
            ...
            aaSorting: [],
        "ajax": {
             "url":  "{{ route('packages-master.index')}}",
            "data": function( d ) {
                d.active=  $('#filter').val();
                }
        }  ,
