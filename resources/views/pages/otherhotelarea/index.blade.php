...
{{-- page title --}}
@section('title','Other Hotel Area List')
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('other-hotel-area.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Create Other Hotel Area</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Other Hotel Area</span>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th></th>
          <th>
            <span>Other Hotel Area Name</span>
          </th>
          <th>Description</th>
          <th>Block</th>
          <th>Floor</th>
...
<script >
    ...
    function deactive(id,obj){
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "{!!URL::to('other-hotel-area/"+id+"' )!!}" ,
                        method: 'DELETE',
                        ...
                        swal("Other Hotel Area  has been deactivated!", {
                            icon: "success",
                        });
                ...
                swal("Your Other Hotel Area is safe", {
                    title: 'Cancelled',
                    icon: "error",
                });
                }
    ...
    function fetch_data( active = '') {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Other Hotel Area"
        },
        select: {
            style: "multi",
