...
{{-- page title --}}
@section('title','Create a Other Hotel Area')
{{-- vendor style --}}
        ...
        <div class="card-content">
            <div class="card-title">
                <div class="row center">
                    <div class="col s12">
                        <h5 class="center-align" style="font-weight: 900;">Create a New Other Hotel Area</h5>
                    </div>
            ...
            <form  class="formValidate" action="{{ route('other-hotel-area.store') }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
                ...
                <div id="details">
                    ...
                    <div class="row">
                        <div class="col s12">
                            ...
                            <div class="input-field">
                                <select  name="floor_id" value="{{old('floor_id')}}"  >
                                    <option value="">Select floor</option>
                                    @foreach ($floors as $floor)
                                        <option value="{{$floor->id}}" {{$floor->id == old('floor_id')? 'selected' : '' }}>{{$floor->name}}</option>
                                    @endforeach
                                </select>
                                @error('floor_id')
                                    <small class="red-text">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <textarea required class="materialize-textarea" name="description">{{old('description')}}</textarea>
                            @error('description')
                                <small class="red-text">
                                    <p>{{ $message }}</p>
                                </small>
