...
{{-- page title --}}
@section('title','Last Minute List')
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('last-minute-discount.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='javascript:void(0)'
      ...
      <span class="hide-on-small-only">Filter Last Minute</span>
...
<script >
    ...
    function deactive(id,obj){
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "{!!URL::to('last-minute-discount/"+id+"' )!!}" ,
                        method: 'DELETE',
                        ...
                        swal("Last Minute  has been deactivated!", {
                            icon: "success",
                        });
    ...
    function fetch_data( active = '') {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Last Minute"
        },
        select: {
            style: "multi",
