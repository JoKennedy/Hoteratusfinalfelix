...
{{-- page title --}}
@section('title','Update Last Minute')
{{-- vendor style --}}
        ...
        <div class="card-content">
            <div class="card-title">
                <div class="row center">
                    <div class="col s12">
                        <h5 class="center-align" style="font-weight: 900;">Last Minute</h5>
                        <p>{{$dicountLastMinute->name}}</p>
                    </div>
                </div>
            </div>

            <form  class="formValidate" action="{{ route('last-minute-discount.update', $dicountLastMinute) }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
                @method('PUT')
                <div class="row"></div>
                <div id="details">
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input name="name" type="text" value="{{old('name', $dicountLastMinute->name)}}" required>
                            @error('name')
                    ...
                    <table id="discountlist">
                        ...
                        <tbody>
                            @foreach ($dicountLastMinute->discount_last_minute_details as $key => $item )
                                <tr>
