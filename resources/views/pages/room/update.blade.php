    ...
    <div class="col s12">
      ...
      <div id="validations" class="card card-tabs">
        ...
        <div class="card-content">
            ...
            <form  class="formValidate" action="{{ route('rooms.update',$room) }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
                @method('PUT')
                ...
                <div id="details">
                    <div class="row">
                        <div class="input-field col s8">
                            ...
                            <input name="name" type="text" value="{{old('name', $room->name)}}" required>
                            @error('name')
                        ...
                        <div class="input-field col s4">
                            ...
                            <input name="code" type="text" value="{{old('code', $room['code'])}}" required>
                            @error('code')
                                <small class="red-text">
                                    <p>{{ $message }}</p>
                                </small>
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                            ...
                            <textarea class="materialize-textarea" name="description">{{old('description', $room->description)}}</textarea>
                            @error('description')
                                <small class="red-text">
                                    <p>{{ $message }}</p>
                                </small>
