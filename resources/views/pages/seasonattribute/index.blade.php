...
{{-- page title --}}
@section('title','Season Attribute List')
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('seasons-attribute.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Create Season Attribute</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Season Attribute</span>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th></th>
          <th>
            <span>Season Attribute Name</span>
          </th>
          <th>Action</th>
          <th>Status</th>
        </tr>
...
<script >
    ...
    function deactive(id,obj){
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "{!!URL::to('seasons-attribute/"+id+"' )!!}" ,
                        method: 'DELETE',
                        ...
                        swal("Season Attribute  has been deactivated!", {
                            icon: "success",
                        });
                ...
                swal("Your Season Attribute is safe", {
                    title: 'Cancelled',
                    icon: "error",
                });
                }
    ...
    function fetch_data( active = '') {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Season Attribute"
        },
        select: {
            style: "multi",
