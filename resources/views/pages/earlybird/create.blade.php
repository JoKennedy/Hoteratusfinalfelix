...
{{-- page title --}}
@section('title','Create a new Early Bird')
{{-- vendor style --}}
        ...
        <div class="card-content">
            <div class="card-title">
                <div class="row center">
                    <div class="col s12">
                        <h5 class="center-align" style="font-weight: 900;">Create a New Early Bird</h5>
                    </div>
                </div>
            </div>

            <form  class="formValidate" action="{{ route('early-bird-discount.store') }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
