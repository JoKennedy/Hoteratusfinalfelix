...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('early-bird-discount.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='javascript:void(0)'
      ...
      <span class="hide-on-small-only">Filter Early Bird</span>
...
<script >
    ...
    function deactive(id,obj){
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "{!!URL::to('early-bird-discount/"+id+"' )!!}" ,
                        method: 'DELETE',
                        ...
                        swal("Early Bird  has been deactivated!", {
                            icon: "success",
                        });
    ...
    function fetch_data( active = '') {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Early Bird"
        },
        select: {
            style: "multi",
