...
<section class="invoice-list-wrapper section">
 ...
 <div class="invoice-filter-action mr-3">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('products.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Add new Product</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Product </span>
...
<script >
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        swal("Product  has been deactivated!", {
                            icon: "success",
                        });
    ...
    function fetch_data( active = '') {
        ...
        var dataListView = $(".invoice-data-table").DataTable({
            ...
            aaSorting: [],
        "ajax": {
             "url":  "{{ route('products.index', ['product_subcategory_id' => $product_subcategory_id])}}",
            "data": function( d ) {
                d.active=  $('#filter').val();
                }
        }  ,
