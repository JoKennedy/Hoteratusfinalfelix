...
{{-- page title --}}
@section('title','Create a new Booking Policy')
{{-- vendor style --}}
        ...
        <div class="card-content">
            <div class="card-title">
                <div class="row center">
                    <div class="col s12">
                        <h5 class="center-align" style="font-weight: 900;">Create a New Booking Policy</h5>
                    </div>
            ...
            <form  class="formValidate" action="{{ route('booking-policy.store') }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
                ...
                <div id="details">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <select onchange="verifyType()" value="{{old('web_policy_type_id')}}" name="web_policy_type_id" id="web_policy_type_id" required>
                                <option value="">Select a Booking Type</option>
                                @foreach ($webPolicyType as $item)
                                    <option value="{{$item->id}}" {{$item->id == old('web_policy_type_id')? 'selected': ''}}>{{$item->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row" id="charges">
                        ...
                        <div class="input-field col s1">
                            <input onkeypress="return isNumberKey(event)" id="charge" name="charge"  type="text" >
                             @error('charge')
                                <small class="red-text">
                                    <p>{{ $message }}</p>
                                </small>
