...
{{-- page title --}}
@section('title','Booking Policy List')
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('booking-policy.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Create Booking Policy</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Booking Policy</span>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th style="max-width: 30%; width:30%;">Before Check In</th>
          <th>Booking Type</th>
          <th>Charges</th>
          <th>Action</th>
          <th>Delete</th>
...
<script >
    ...
    function deactive(id,obj){
         ...
         swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        if(response.success){
                            ...
                            swal("Booking Policy  has been removed!", {
                                icon: "success",
                            });
                        }
                ...
                swal("Your Booking Policy is safe", {
                    title: 'Cancelled',
                    icon: "error",
                });
                }
    ...
    function fetch_data( active = '') {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Booking Policy"
        },
        select: {
            style: "multi",
