...
{{-- page title --}}
@section('title','Special Period List')
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('special-periods.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Create Special Period </span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Special Period </span>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th></th>
          <th>
            <span>Special Period Title</span>
          </th>
...
<script >
    ...
    function deactive(id,obj){
         ...
         swal({
                title: "Are you sure?",
                text: "You can't activate it, when you need it!",
                icon: 'warning',
                dangerMode: true,
                buttons: {
                cancel: 'No, Please!',
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        filter(1);
                        swal("Special Period   has been deactivated!", {
                            icon: "success",
                        });
                ...
                swal("Your Special Period  is safe", {
                    title: 'Cancelled',
                    icon: "error",
                });
                }
    ...
    function fetch_data( active = 1) {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Special Period "
        },
        select: {
            style: "multi",
