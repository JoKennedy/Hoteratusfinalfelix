        ...
        <div class="card-content">
            <div class="card-title">
                <div class="row center">
                    <div class="col s12">
                        <h5 class="center-align" style="font-weight: 900;">Special Period</h5>
                        <p>{{$specialPeriod['name']}}</p>
                    </div>
            ...
            @endif
            <form  class="formValidate" action="{{ route('special-periods.update', $specialPeriod) }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
                @method('PUT')
