    ...
    <div class="col s12">
      ...
      <div id="validations" class="card card-tabs">
        ...
        <div class="card-content">
            ...
            @endif
            <form  class="formValidate" action="{{ route('productcategories.store') }}" style="margin-bottom: 20px;" id="formSubmit" method="POST">
                @csrf
                <div class="row"></div>
                <div id="details">
                    <div class="row">
                ...
                <div class="row s12 right">
                    ...
                    <a href="{{ route('productcategories.index') }}" class="mb-6 btn waves-effect waves-light gradient-45deg-purple-deep-orange">Cancel</a>
                </div>
            </form>
        </div>
      </div>
