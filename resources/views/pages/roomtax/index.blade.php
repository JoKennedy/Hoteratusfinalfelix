...
{{-- page title --}}
@section('title','Room Tax/Fee List')
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('room-taxes.create')}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Create Tax/Fee</span>
    </a>
  </div>
  ...
  <div class="filter-btn">
    ...
    <a class='dropdown-trigger btn waves-effect waves-light purple darken-1 border-round' href='#'
      ...
      <span class="hide-on-small-only">Filter Tax/Fee</span>
...
<script >
    ...
    function fetch_data( active = '') {
        ...
        language: {
            search: "",
            searchPlaceholder: "Search Tax/Fee"
        },
        select: {
            style: "multi",
