...
return [
    'custom' => [
        'mainLayoutType' => 'vertical-menu-nav-dark', //Options:vertical-modern-menu,vertical-menu-nav-dark,vertical-gradient-menu,vertical-dark-menu,horizontal-menu, default(vertical-modern-menu)
        ...
        'navbarBgColor' => 'gradient-45deg-green-teal', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'activeMenuType' => 'sidenav-active-rounded', //Options:default("") sidenav-active-square, sidenav-active-rounded, sidenav-active-fullwidth  Warning:this option is not applicable for horizontal
        'isFooterDark' => null, //True for dark, flase for light and null for default
        'isFooterFixed' => false, //options:true or false
        'templateTitle' => 'Hoteratus', //template Title can be changes default('Materialize)
        ...
        'largeScreenLogo' => 'images/logo/logo.png', //we used saparete log image for large screen and small
